...
- ## Initial CU and ALU Decode 

- ## Debugging and initial JAL decode logic

- ## Testbench for each components I made - except Pipeline ffs

- ## Initial Pipeline Registers

- ## Direct mapped Cache - Still being worked on

## Overview
- [**PC**](#pc-and-byte-addressed-intruction-memory)
- [**Instruction memory**](#instruction-memory)
- [**Initial CU with ALU Decode**](#initial-cu-with-aludecode)
- [**Debugging and initial JAL decode logic**](#debugging)
- [**Testbenches for most components I made**](#testbench-for-each-components-i-made-except-pipeline-ffs)
...
### Commit - e4aba55dcabe68d1e627c2f829add5d4605561de
...
### Commits - 8a34d92d873b0964a481bd11399af6549bc0e1fc and 6b0b82fa737fb0b2986d670840a378661d4461d7
...
### Instruction Memory -  0587ea9b69b5ba94a4e103e0ef6a7bf394a7bc6f
...
```
I mainly used the instruction memory to do testing since modifying since this was too tedious to test with.

For the initial CU i tested this with my test bench which can be seen at `CU_tb.cpp` commit - 8e215ff86ba79a86665379dc7ff697210664dc91
...
I did not make other modules i made like the direct mapped cache and pipeline registers , since the best way I found to test if they work is to connect it to our original cpu and see what breaks and reverse engineer the module, depending on the signals from traces.

### Pipeline Registers

I made the initial pipeline registers which can be seen here - b8cade9a9a31ca8542d184cc318da4ebc3efbfaf
